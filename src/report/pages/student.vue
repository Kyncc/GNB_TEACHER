<template >
    <view-box v-ref:view-box class="reportStudent">
        ...
        <div style="padding-top:46px">
            <accordion :list="reportChapter" :link="_toDetail()" @on-click-back="_openChapter" ></accordion>
    ...
    <gnb-change-sub :visible.sync="visible" :selected="reportSubjectId" :subject="userSubjectList" @on-click-back="_changeSubject"></gnb-change-sub>
</template>
