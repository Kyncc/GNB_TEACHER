...
import {token,userSubjectList,id,userGrade,chapterId} from '../../common/getters'
import { brushList,brushSubjectId,brushListScoll,brushListOffset} from '../getters'
import { setScoll,getBushList,bushListAction } from '../actions/list'
import '../index.less'
...
export default {
    ...
    methods: {
        _intoDetail(id){
            ...
            this.$router.go(`/example/${this.id}/${this.brushSubjectId}/${id}`);
        },
    ...
    vuex: {
        getters: {
            token,userSubjectList,id,userGrade,chapterId,
            brushList,brushSubjectId,brushListScoll,brushListOffset
        },
        actions: {
           setScoll,getBushList,bushListAction
        }
    },
    data(){
        return{
