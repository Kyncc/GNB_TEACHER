<template>
  <view-box body-padding-top="46px" body-padding-bottom="40px">
    ...
    <card v-for='(error, index) in ErrorclassRemember.download' :key='index'>
    ...
    <div style="text-align:center;padding:10px 0;">
      ...
      <p v-else-if="ErrorclassRemember.download.length === 0" style="font-size:16px;color:#4cc0be">您还未有组卷</p>
    ...
    <tabbar slot="bottom" style='background-color:#4cc0be;color:#fff' v-show='ErrorclassRemember.download && ErrorclassRemember.download.length'>
