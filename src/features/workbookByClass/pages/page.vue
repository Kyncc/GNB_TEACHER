  ...
  route: {
    data:function(transition){
      if(this.workbookClassPage.isReset){
        ...
        this.$nextTick(()=>{
          document.getElementsByClassName("vux-fix-safari-overflow-scrolling")[0].scrollTop = this.workbookClassPage.scoll;
        });
      }
    }
  },
  methods:{
    ...mapActions(['getWorkbookClassPage','setWorkbookClassPageScoll','workbookClassExerciseClear']),
    _intoPage(){
