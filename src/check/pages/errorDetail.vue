...
import {token,id,subject_id} from '../../common/getters'
import {fetchStudentId } from '../../class/getters.js'
import {errorIndexDetail} from '../getters'
import {getErrorDetail } from '../actions'
...
export default {
	...
	vuex: {
        getters: {
            token,id,
			errorIndexDetail,fetchStudentId,subject_id
        },
        actions: {
	...
	methods: {
		...
		// },
		_correct(){
			this.$router.go(`/correct/${this.subject_id}/${this.list[0].id}`);
		},
		// _back() {
